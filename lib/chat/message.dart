...
class _Message extends State<Message> {
  ...
  _validateFields() {
    ...
    if (username.isNotEmpty && username.contains(username_pattern) && username.length >= 3 && username.length <= 8) { //added max length [buffer] - Nov 11
      if (phone.isNotEmpty && phone.contains(phone_pattern) && phone.length >= 6 && phone.length <= 10) { //added max length [buffer] - Nov 11
        if (message.isNotEmpty && message.length >= 1 && message.length <= 300) { //added max length [buffer] - Nov 11
  ...
  //anonymous login method - added on Nov-28-2021
  ...
  Future<void> _submitPhoneNumber() async {
    String phoneNumber = "+1 " + _controllerPhone.text.toString().trim();

    RecaptchaVerifier recaptcha = RecaptchaVerifier(
      onSuccess: () async {},
  ...
  Widget buildMessageBtn() {
    return Container(
      ...
      child: RaisedButton(
        elevation: 5,
        onPressed: () => { _submitPhoneNumber() }, //validate existing user from Firebase DB
      ...
      drawer: Drawer(
        child: ListView(
          ...
          children: [
            ...
            ListTile(
              title: Text(S.current.mainHome, style: TextStyle(
            ...
            ListTile(
              title: Text(S.current.mainLogin, style: TextStyle(
            ...
            ListTile(
              title: Text(S.current.mainChat, style: TextStyle(
                  fontFamily: 'fonts/SourceSansPro-Bold.ttf',
                  fontSize: 17.0),),
              onTap: () {
                Navigator.push(
            ...
            ListTile(
              title: Text(S.current.mainContact, style: TextStyle(
                  fontFamily: 'fonts/SourceSansPro-Bold.ttf',
                  fontSize: 17.0),),
              onTap: () {
            ...
            ListTile(
              title: Text(S.current.mainWebsite, style: TextStyle(
                  fontFamily: 'fonts/SourceSansPro-Bold.ttf',
                  fontSize: 17.0),),
              onTap: () {
